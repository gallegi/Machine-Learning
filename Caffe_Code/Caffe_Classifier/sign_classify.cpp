...
//  string trained_file = "model/_iter_437.caffemodel";
...
//	    unsigned int t_start = 	(int)cv::getTickCount();
//	    std::vector<Prediction> predictions = classifier.Classify(img);
//	    unsigned int t_end = cv::getTickCount();
//	    //std::cout << 1/((t_end - t_start)/cv::getTickFrequency()) << std::endl;
//
